...
FuzzyLogic::FuzzyLogic()
{
    ...
    g.rightStart = 4;
    g.rightEnd = 10;
    this->mySets[HURTING_ENEMY] = FuzzySet(HURTING_ENEMY, "Hurting Enemy", g);
    ...
    g.rightStart = 4;
    g.rightEnd = 10;
    this->mySets[HELPING_ME] = FuzzySet(HELPING_ME, "Helping Me", g);
    ...
    g.rightStart = 4;
    g.rightEnd = 6;
    this->mySets[TURNS_AWAY] = FuzzySet(TURNS_AWAY, "Turns Away", g);
}
